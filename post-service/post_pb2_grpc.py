...
class PostServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListPostsByUser = channel.unary_unary(
                '/post.PostService/ListPostsByUser',
                request_serializer=post__pb2.ListPostsByUserRequest.SerializeToString,
                response_deserializer=post__pb2.ListPostsByUserResponse.FromString,
                _registered_method=True)
...
def add_PostServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListPostsByUser': grpc.unary_unary_rpc_method_handler(
                    servicer.ListPostsByUser,
                    request_deserializer=post__pb2.ListPostsByUserRequest.FromString,
                    response_serializer=post__pb2.ListPostsByUserResponse.SerializeToString,
            ),
    }
...
class PostService(object):
    ...
    def ListPostsByUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/post.PostService/ListPostsByUser',
            post__pb2.ListPostsByUserRequest.SerializeToString,
            post__pb2.ListPostsByUserResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
